package de.tudresden.inf.st.most.deserializer;
...
import de.tudresden.inf.st.most.jastadd.ast.ASTNode;
import de.tudresden.inf.st.most.jastadd.ast.List;
import de.tudresden.inf.st.most.jastadd.ast.Opt;
...
public class ASTNodeDeserializer extends StdDeserializer<ASTNode> {
  ...
  private ASTNode deserializeNonterminal(JsonNode node) {
    ...
    final String packageName = "de.tudresden.inf.st.most.jastadd.ast";
